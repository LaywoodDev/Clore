...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-1.5 px-2.5 py-1.5 pr-8 text-sm text-current outline-hidden select-none transition-colors data-highlighted:bg-accent data-highlighted:text-current data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:text-current",
        className
      )}
      {...props}
    >
